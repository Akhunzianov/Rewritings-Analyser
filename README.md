...
###### Достоинства подхода:
* Высокая точность определения рерайтингов: алгоритм учитывает все основные приёмы рерайтинга и с высокой точностью определяет, является ли предложение рерайтингом
...
###### Недостатки подхода:
• Достаточно большое время работы: Алгоритм работает за время O(n2m2(l2+k)), где n – количество текстов в датасете, m – cреднее количество слов длины не менее 3 в одном тексте, l – среднее количество букв в слове длины хотя бы 3 в датасете, k – среднее количество синонимов у слова длины хотя бы 3 в датасете
